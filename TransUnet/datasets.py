...
class LiverDataset(data.Dataset):
    ...
    def get_transform(self):
        ...
        # 随机填充
        # A.PadIfNeeded(p=0.5,min_height=512,min_width=512),
        # 随机裁剪
        # A.RandomCrop(p=0.5,always_apply=False,height=384,width=384),
        # 任选其一进行增强
        A.OneOf([
            # 参数：随机色调、饱和度、值变化。
...
if __name__ == '__main__':
    root = "../cvc_clinicdb/test"
    label = "../cvc_clinicdb/test_label"
