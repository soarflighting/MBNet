...
def resnet101(bn_momentum=0.1, pretrained=False,output_stride=16):
    ...
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], bn_momentum, pretrained,output_stride=output_stride)
    return model
...
def resnet50(bn_momentum=0.1,pretrained=False,output_stride=16):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck,[3, 4, 6, 3],bn_momentum,pretrained,output_stride=output_stride)
    return model
...
def resnet152(bn_momentum=0.1, pretrained=False,output_stride=16):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 36, 3], bn_momentum, pretrained,output_stride=output_stride)
    return model
