...
def validate(config,val_loader,model,criterion):
    ...
    with torch.no_grad():
        ...
        for input,target in pbar:
            ...
            miou,pc,recall,fpr,precision,mac,dice = eval_seg(output[0], target, config['num_classes'])
            aji = calculate_AJI(output[0],target)
            hd = eval_hausdorff(output[0],target)
...
def main():
    ...
    model_path = "./models/stomachdata_DRANet_TRAIN/model_292.pth"
    # model_path = "./models/stomachdata_DRANet_TRAIN/model_167.pth"
    # model_path = "./models/kvasir_data_DRANet_TRAIN/model_249.pth"

    model.load_state_dict(torch.load(model_path,map_location='cpu'))
    test_root = "../data08/test"
    test_label = "../data08/test_label"
    # test_root ="../kvasir_unet3plus/test"
    # test_label ="../kvasir_unet3plus/test_label"
