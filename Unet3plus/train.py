...
def parse_args():
    ...
    # dataset
    parser.add_argument('--dataset', default='kavsir_dataset',help='dataset name')
    # 线程数 默认为0
...
def main():
    ...
    dataloaders = DataLoader(liver_dataset, batch_size=config['batch_size'],shuffle=True,num_workers=config['num_workers'])
