...
def parse_args():
    ...
    # model
    parser.add_argument('--model', '-a', metavar='model', default='att_unet')
    # 输入通道数
    ...
    # dataset
    parser.add_argument('--dataset', default='stomachdataset', help='dataset name')
    # 线程数 默认为0
...
def main():
    ...
    for epoch in range(config['epochs']):
        ...
        if val_log['iou'] > best_iou and val_log['iou'] > 0.5:
